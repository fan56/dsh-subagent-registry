...
import { listAgentFiles, parseAgentMarkdown } from "./agents-dir.js";
/**
 ...
 */
export function bundledAgentsTemplatesDir() {
 ...
 */
export function seedBundledAgents(targetDir, sourceDir = bundledAgentsTemplatesDir()) {
